...
describe('<%= upperCaseName %>', () => {
  ...
  beforeEach(inject((_$rootScope_) => {
    ...
    makeController = () => {
      return new <%= upperCaseName %>Controller();
    };
  }));
  ...
  describe('Template', () => {
    ...
    it('has name in template [REMOVE]', () => {
      expect(<%= upperCaseName %>Template).to.match(/{{\s?vm\.name\s?}}/g);
    });
  });
  ...
  describe('Component', () => {
    ...
    it('includes the intended template',() => {
      expect(component.template).to.equal(<%= upperCaseName %>Template);
    });
    ...
    it('invokes the right controller', () => {
      expect(component.controller).to.equal(<%= upperCaseName %>Controller);
    });
  });
});
